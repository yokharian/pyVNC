...
from pyVNC.RFBToGUI import (
    RFBToGUIeightbits as RFBToGUIeightbits_ORIGINAL,
    RFBToGUI as RFBToGUI_ORIGINAL,
)
from pyVNC.VNCFactory import VNCFactory as VNCFactory_ORIGINAL
from pyVNC.rfb import (
    ...
    CORRE_ENCODING,
    RRE_ENCODING,
    RFBClient as RFBClient_ORIGINAL,
)

os.environ["PYGAME_HIDE_SUPPORT_PROMPT"] = "hide"
import time
from pyVNC import constants, pyDes
...
# Mac alternative (Testing is needed)
class RFBClient(RFBClient_ORIGINAL):
...
# Mac alternative (Testing is needed)
# function def send_password of RFBToGUI class has to reference RFBDes class in this file
class RFBToGUI(RFBToGUI_ORIGINAL, RFBClient): ...


# Mac alternative (Testing is needed)
# function def send_password of RFBToGUIeightbits class has to reference RFBDes class in this file
class RFBToGUIeightbits(RFBToGUIeightbits_ORIGINAL, RFBToGUI): ...


# Mac alternative (Testing is needed)
class VNCFactory(VNCFactory_ORIGINAL):
    protocol = RFBClient

    def __init__(self, buffer, depth, fast, *args, **kwargs):
        VNCFactory_ORIGINAL.__init__(self, *args, **kwargs)
        self.buffer = buffer
